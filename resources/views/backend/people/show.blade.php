                          ...
                          <div class="card-header d-flex justify-content-between align-items-center">
                              ...
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profileDropdown">
                                      ...
                                      <a class="dropdown-item" href="#">Edit death</a>
                                      <a class="dropdown-item" href="#">Edit photos</a>
                        ...
                        <div class="col-md-6 mb-3">
                              ...
                              <div class="card-header d-flex justify-content-between align-items-center">
                                  ...
                                  <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="familyDropdown">
                                          ...
                                          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#motherCrudObjectModal">Add monther</a>
                                          <div class="dropdown-divider"></div>
                                          <a class="dropdown-item" href="#">Edit family</a>
                                          {{-- <a class="dropdown-item text-danger" href="#">Delete family</a> --}}
                                      </div>
                                  </div>
                              </div>
                              <div class="card-body">
                                  <ul class="list-group list-group-flush">
                                      <li class="list-group-item">Father <span></span></li>
                                      <li class="list-group-item">Mother <span></span></li>
                                      <li class="list-group-item">Parents <span></span></li>
                                      <li class="list-group-item">Partner <span></span></li>
                                  </ul>
                              </div>
                          </div>
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="partnersDropdown">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        {{-- <a class="dropdown-item text-danger" href="#">Delete partners</a> --}}
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="childrenDropdown">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        {{-- <a class="dropdown-item text-danger" href="#">Delete children</a> --}}
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                          ...
                          <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    {{-- <button class="btn btn-tool dropdown-toggle" type="button" id="siblingsDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fas fa-bars"></i>
                                    </button> --}}

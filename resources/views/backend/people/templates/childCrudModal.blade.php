...
<div class="modal fade" id="childCrudObjectModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form id="frmChildCrudObject" action="{{ route('admin.people.storeChild') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="modal-header">
          <h5 class="modal-title">Add Child</h5>
          <button id="buttonClose" type="button" class="close" data-dismiss="modal" aria-label="Close">x</button>
        ...
        <div class="modal-body">
          ...
          <div class="tab-content" id="childTabsContent">
            ...
            <div class="tab-pane fade" id="existing-child" role="tabpanel" aria-labelledby="existing-child-tab">
              <div class="form-group">
                <label for="existing_child" class="form-control-label mb-1">Select Existing Person:</label>
                <select id="existing_child" name="existing_child" class="form-control select2">
                  <!-- Options will be populated dynamically -->
                  <option value="">Select Person</option>
                </select>
                <span class="text-danger error-text existing_child_error"></span>
              </div>
            </div>
          </div>
        </div>

            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="form-group">
                    <label for="email" class="form-control-label mb-1">Provice Code: <span class="text-danger">*</span></label>
                    <input id="province_code" name="province_code" class="form-control" type="text" placeholder="Code">

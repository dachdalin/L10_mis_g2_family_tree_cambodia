...
@section('content')
  ...
  @include('backend.role.templates.crudModal')
@endsection
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#addNewObject').on('click',function(e){
        ...
        $('#frmCrudObject').on('hidden.bs.modal', function (){
          $('#field_error').find('.error-text').html('');          
        });


        $('#crudObjectModal').find('.modal-title').html('Add New Role');
        $('#frmCrudObject').find('#object_id').val('');
        $('#frmCrudObject').find('#btnObjectSave').html('<i class="fadeIn animated bx bx-plus-circle"></i>&nbsp;Save');
